...
def init_db():
    ...
    programs = [
        # 篇章一：青春启幕，声动百甘
        (1, 1, 1, '浪漫血液', '金峰臣', '动物医学院', '独唱'),
        (2, 1, 2, '美丽的神话', '张龄之、徐瑞苑', '商旅学院', '合唱'),
        (3, 1, 3, '你给我听好', '王琪', '经济学院', '独唱'),
        (4, 1, 4, '听见下雨的声音', '吴启杭、张又衡、陈浩', '动物科技学院', '合唱'),
        # 篇章二：沃野逐光，艺展芳华
        (5, 2, 5, '春风十里', '李智强', '林学院', '吉他弹唱'),
        (6, 2, 6, '逐光颂', '于璇璇、吴旻鸿、何沁、符文洋、丁钰会、席茗洁', '动物科技学院', '舞蹈'),
        (7, 2, 7, '海阔天空', '叶朝卿', '水稻研究所', '独唱'),
        # 篇章三：研途有声，青春正燃
        (8, 3, 8, '风吹麦浪', '石瑾玲、宋佳', '食品学院', '合唱'),
        (9, 3, 9, '路过人间', '廖远博、何旭颖', '资源学院', '对唱'),
        (10, 3, 10, '我不知道', '程雨豪', '动物营养研究所', '独唱'),
        # 篇章四：百甘回响，奔赴山海
        (11, 4, 11, '青春节拍', '张雯涵、胡铭、张嘉宝、毛雯琪、魏芊珣', '艺术与传媒学院', '舞蹈'),
        (12, 4, 12, 'Scarborough Fair', '张佳艺', '管理学院', '独唱'),
        (13, 4, 13, '我只在乎你', '王成燕', '马克思主义学院', '独唱'),
        # 篇章五：萤窗相照，未来乘风
        (14, 5, 14, '肆意的河', '王朴', '林学院', '弹唱'),
        (15, 5, 15, '这世界那么多人', '郑洁欣', '经济学院', '舞蹈'),
        (16, 5, 16, '大地之子', '黑来拉批', '理学院', '弹唱'),
    ]
